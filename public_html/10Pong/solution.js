...
// Dibujar la raqueta
    ...
    // Verifica si la pelota ha tocado el borde izquierdo del lienzo.
    if (position.x < r) {
        // Colisión con el borde izquierdo
        position.x = r; // Ajustar la posición horizontal al borde izquierdo
        velocity.x *= -1; // Revertir la velocidad horizontal
    }
